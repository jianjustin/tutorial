...
const (
	AddService_Add_FullMethodName         = "/pb.AddService/Add"
	AddService_AddAfterMul_FullMethodName = "/pb.AddService/AddAfterMul"
)
...
type AddServiceClient interface {
	...
	AddAfterMul(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error)
}
...
func (c *addServiceClient) Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	out := new(AddResponse)
	err := c.cc.Invoke(ctx, AddService_Add_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addServiceClient) AddAfterMul(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	out := new(AddResponse)
	err := c.cc.Invoke(ctx, AddService_AddAfterMul_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddServiceServer interface {
	...
	AddAfterMul(context.Context, *AddRequest) (*AddResponse, error)
...
func (UnimplementedAddServiceServer) AddAfterMul(context.Context, *AddRequest) (*AddResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddAfterMul not implemented")
}
...
func _AddService_AddAfterMul_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddServiceServer).AddAfterMul(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AddService_AddAfterMul_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).AddAfterMul(ctx, req.(*AddRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AddService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddAfterMul",
			Handler:    _AddService_AddAfterMul_Handler,
		},
	},
