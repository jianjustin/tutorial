...
import (
	...
	"go.guide/tutorial/go-kit/addsvc/endpoint"
	"go.guide/tutorial/go-kit/addsvc/pb"
	"go.guide/tutorial/go-kit/addsvc/service"
	"go.guide/tutorial/go-kit/addsvc/transport"
...
func main() {
	...
	var (
		...
		endpoints   = endpoint.New(service, logger, duration, tracer, zipkinTracer)
